...
// Este arquivo NAO contem logica de fisica, colisao ou pontuacao
...
/**
 * Encerra a partida: salva o score localmente, envia ao servidor e exibe a tela de game over.
 */
function _endGame() {
  ...
  }).catch((err) => console.warn("Falha ao enviar score:", err));
